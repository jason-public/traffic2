...
// just extract the first array `export const autoRepairComprehensive = [...]`
const arrStr = code.substring(code.indexOf('export const autoRepairComprehensive = ['), code.indexOf('export const autoRepairSmall = ['));
